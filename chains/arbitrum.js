...
if (!contractAddress || !receiver) {
  throw Error("Usage: node chains/arbitrum.js <contractAddress> <receiver>");
}

const provider = new ethers.JsonRpcProvider(
  "https://arbitrum.llamarpc.com" // Paste your RPC Provider
);

const gasSender = new ethers.Wallet(process.env.GAS_SENDER, provider);

const apiKey = process.env.ARBITRUM_API_KEY;
const arbitrumURL = "https://api.arbiscan.io/api";
